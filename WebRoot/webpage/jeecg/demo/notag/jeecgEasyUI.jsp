...
<body style="overflow-y: hidden" scroll="no">
	<form id="formobj" action="jeecgEasyUIController.do?save"
		name="formobj" method="post">
		<input type="hidden" id="btn_sub" class="btn_sub" /> <input id="id"
			name="id" type="hidden" value="${jeecgJdbcPage.id }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			class="formtable">
			<tr>
				<td align="right"><label class="Validform_label"> 年龄: </label>
				</td>
				<td class="value"><input class="inputxt" id="age" name="age"
					ignore="ignore" value="${jeecgJdbcPage.age}" datatype="n">
			...
			<tr>
				...
				<td class="value"><input class="Wdate"
					...
					style="width: 150px" id="birthday" name="birthday" ignore="ignore"
				...
				<td class="value"><select id="depId" name="depId" datatype="*">
						<c:forEach items="${departList}" var="depart">
							<option value="${depart.id }"
								${depart.id==jeecgJdbcPage.depId?'selected':''}>
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="email"
					name="email" ignore="ignore" value="${jeecgJdbcPage.email}">
					<span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				...
				<td class="value"><input class="inputxt" id="mobilePhone"
					...
					value="${jeecgJdbcPage.mobilePhone}"> <span
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="officePhone"
					...
					value="${jeecgJdbcPage.officePhone}"> <span
					class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 工资: </label>
				</td>
				<td class="value"><input class="inputxt" id="salary"
					name="salary" ignore="ignore" value="${jeecgJdbcPage.salary}"
			...
			<tr>
				...
				<td class="value">
					<t:dictSelect field="sex" typeGroupCode="sex" hasLabel="false" defaultVal="${jeecgJdbcPage.sex}" type="radio"></t:dictSelect>
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="userName"
					name="userName" value="${jeecgJdbcPage.userName}" datatype="*">
					<span class="Validform_checktip"></span></td>
			</tr>
		</table>
