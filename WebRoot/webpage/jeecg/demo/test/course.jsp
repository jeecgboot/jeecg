  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="courseController.do?save">
			...
			<table style="width: 660px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="teacher" name="teacher.name" ignore="ignore"
							   value="${coursePage.teacher.name}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr style="display: none">
					...
					<td class="value">
						<input class="inputxt" id="teacher" name="teacher.id" ignore="ignore"
							   value="${coursePage.teacher.id}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
		...
		<table style="display: none">
			 <tbody id="add_jeecgStudent_table_template">
				<tr>
					...
					<td align="left">
					<t:dictSelect field="students[#index#].sex" typeGroupCode="sex" hasLabel="false" ></t:dictSelect>
					</td>
				</tr>
			</tbody>
		</table>
