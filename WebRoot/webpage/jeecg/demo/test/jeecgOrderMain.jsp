...
<%--							   value="${jeecgOrderMainPage.usertype}">--%>
		...
		<tbody id="add_jeecgOrderProduct_table_template">
            ...
            errormsg="订单产品明细的产品个数必须为数字" name="jeecgOrderProductList[#index#].gopCount" maxlength="10" type="text" style="width:120px;"></td>
			 <td align="left">
<%--			 <input name="jeecgOrderProductList[#index#].gopProductType" maxlength="3" type="text" style="width:120px;">--%>
            ...
            errormsg="订单产品明细的产品单价填写不正确" name="jeecgOrderProductList[#index#].gopOnePrice" maxlength="10" type="text" style="width:120px;"></td>
			 <td align="left"><input nullmsg="请输入订单产品明细的产品小计！" datatype="d"
            errormsg="订单产品明细的产品小计填写不正确" name="jeecgOrderProductList[#index#].gopSumPrice" maxlength="10" type="text" style="width:120px;"></td>
