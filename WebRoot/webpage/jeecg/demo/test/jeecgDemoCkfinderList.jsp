...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:1px;">
		<t:datagrid name="jeecgDemoCkfinderList" title="ckeditor+ckfinder例子"
			actionUrl="jeecgDemoCkfinderController.do?datagrid" idField="id"
			fit="true">
			...
			<t:dgDelOpt title="删除"
				url="jeecgDemoCkfinderController.do?del&id={id}" />
			<t:dgToolBar title="录入" icon="icon-add"
				url="jeecgDemoCkfinderController.do?addorupdate" funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit"
				url="jeecgDemoCkfinderController.do?addorupdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search"
				url="jeecgDemoCkfinderController.do?addorupdate" funname="detail"></t:dgToolBar>
