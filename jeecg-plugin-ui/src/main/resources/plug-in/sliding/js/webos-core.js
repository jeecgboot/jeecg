	...
	return me = {
		...
		bindEvent:function(){
		   me.innerbox.find("a[cmd='switch']").click(function(){
				...
				//update-begin--Author:gj_shaojc  Date:20180421 for：TASK #2667 【云桌面】点击10以后的分类，再点击其他功能就不能点击了
				var currentindex = parseInt(classname.substring(classname.lastIndexOf("_")+1));	
				//update-end--Author:gj_shaojc  Date:20180421 for：TASK #2667 【云桌面】点击10以后的分类，再点击其他功能就不能点击了
