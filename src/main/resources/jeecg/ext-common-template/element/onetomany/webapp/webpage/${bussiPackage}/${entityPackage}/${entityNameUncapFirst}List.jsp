...
<body style="background-color: #FFFFFF;">
	<div id="${entityName?uncap_first}List" v-cloak>
		...
		<!--列表-->
		<el-table :data="${entityName?uncap_first}s" border stripe highlight-current-row size="mini" v-loading="listLoading" @sort-change="handleSortChange" @selection-change="selsChange" style="width: 100%;">
		...
		data() {
			return {
				...
				url:{
					...
					goEdit:'${entityName?uncap_first}Controller.do?goForm',
