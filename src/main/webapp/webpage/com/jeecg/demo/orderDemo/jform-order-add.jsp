        ...
        F.ready(function () {
            F.ui({
                ...
                items: [{
                        ...
                        ,items: [{
	                        ...
	                        ,bars: [{
	                            ...
	                            items: [{
	                                ...
	                                handler: function () {
	                                    F.ui.customerGrid.addNewRecord({name:'Jack',money:'122345',sex:'0'}, true);
	                                }
	                            }, {
                    ...
                    type: 'button', cls: 'marginr', id:'subBtn', text: '保存订单', validateForm: 'form1', iconFont: 'f-iconfont-save', style: 'top:5px;left:1060px;',
                    handler: function () {
                        ...
                        $.ajax({ 
	                        url : 'jformOrderMainController.do?doAdd', 
	                        type : 'POST', 
	                        data : formData, 
	                        processData : false, 
	                        contentType : false,
