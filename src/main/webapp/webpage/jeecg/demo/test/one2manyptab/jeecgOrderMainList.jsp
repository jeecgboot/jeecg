...
<div region="center" style="padding: 1px;"><t:datagrid name="jeecgOrderMainList" title="订单信息" actionUrl="jeecgOrderMainPTabController.do?datagrid" idField="id" fit="true">
