package org.jeecgframework.excel;
...
import org.jeecgframework.excel.annotation.Excel;
import org.jeecgframework.excel.annotation.ExcelCollection;
import org.jeecgframework.excel.annotation.ExcelTarget;
import org.jeecgframework.excel.entity.ComparatorExcelField;
import org.jeecgframework.excel.entity.ExcelExportEntity;
import org.jeecgframework.excel.entity.ExcelTitle;
import org.jeecgframework.excel.entity.TemplateExportParams;
...
public final class ExcelExportUtil {
	...
	private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row,
		...
		if(entity.getExportImageType()==1){
			...
			try {
				String path = Thread.currentThread().getContextClassLoader().getResource("").toURI().getPath() +string;
			...
			if(value != null){
				patriarch.createPicture(anchor,
						row.getSheet().getWorkbook().addPicture(value,HSSFWorkbook.PICTURE_TYPE_JPEG));
			}
		}
