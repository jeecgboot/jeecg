...
import jeecg.cgform.entity.enhance.CgformEnhanceJsEntity;
import jeecg.demo.entity.test.CKEditorEntity;
import jeecg.demo.entity.test.CourseEntity;
import jeecg.demo.entity.test.JeecgDemoCkfinderEntity;
import jeecg.demo.entity.test.JeecgJdbcEntity;
import jeecg.demo.entity.test.JeecgMatterBom;
...
import jeecg.demo.entity.test.TSStudent;
import jeecg.demo.entity.test.TeacherEntity;
import jeecg.system.dao.repair.RepairDao;
...
public class RepairServiceImpl extends CommonServiceImpl implements
	...
	private void repairDemo() {
		...
		String html = new FreemarkerHelper().parseTemplate(
				"/jeecg/system/txt/valid-code-demo.ftl", null);
	...
	private void repairMenu() {
		...
		formconfig1
				.setFunctionUrl("cgAutoListController.do?list&id=jform_cgreport_head");
