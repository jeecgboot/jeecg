...
//            var orgIds = $("#orgSelect").combobox("getValues");
		...
		function openDepartmentSelect() {
			...
			$.dialog({content: 'url:departController.do?myDepartSelect&orgIds='+orgIds, zIndex: getzIndex(), title: '组织机构列表', lock: true, width: '400px', height: '350px', opacity: 0.4, button: [
...
<body >
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveInterfaceUser" beforeSubmit="setOrgIds">
