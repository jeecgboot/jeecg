...
public class ${entityName}Controller extends BaseController {
	...
	/**
	 * ${ftl_description}首页跳转
	 * @return
	 */
	@RequestMapping(params = "list")
	public ModelAndView index(HttpServletRequest request) {
		return new ModelAndView("${bussiPackage?replace(".","/")}/${entityPackage}/${entityName?uncap_first}-index");
	}
	...
	public ModelAndView mainForm(${entityName}Entity ${entityName?uncap_first},HttpServletRequest req) {
		...
		return new ModelAndView("${bussiPackage?replace(".","/")}/${entityPackage}/page-${entityName?uncap_first}");
	}
	
	<#list subTab as sub>
	/**
	 * 加载form列表[${sub.ftlDescription}]
	 * 
	 * @return
	 */
	@RequestMapping(params = "${sub.entityName?uncap_first}FormList")
	public ModelAndView  ${sub.entityName?uncap_first}List(${entityName}Entity ${entityName?uncap_first},HttpServletRequest req) {
	
		//===================================================================================
		//获取参数
	    Object id = ${entityName?uncap_first}.getId();
		//===================================================================================
	    ...
	    try{
	    	List<${sub.entityName}Entity> ${sub.entityName?uncap_first}EntityList = systemService.findHql(hql${sub_index},id);
			req.setAttribute("${sub.entityName?uncap_first}List", ${sub.entityName?uncap_first}EntityList);
		}catch(Exception e){
			logger.info(e.getMessage());
		}
		return new ModelAndView("${bussiPackage?replace(".","/")}/${sub.entityPackage}/page-${sub.entityName?uncap_first}");
	}
	</#list>
