						 ...
						 <#elseif po.showType=='popup'>
						     ...
						     <#elseif po.showType=='password'>
								...
								<#elseif po.showType=='date'>
						      	...
						      	<#-- update--begin--author:zhangjiaqiang date:20170531 for:数据回显表格ID区分 -->
									<table id="${fieldMeta[po.fieldName]?lower_case}_fileTable" style="width: max-content;"></table>
							...
							<#elseif po.showType=='tree'>
								<input id="${po.fieldName}" ${po.extendJson?if_exists}  type="text"
					               ...
					               <#-- update--begin--author:Yandong date:20180320 for:TASK #2574 【代码生成器】代码生成效果有问题 1. 树控件样式 2. 有附件的，应该弹窗宽一些 -->
					               onclick="show${po.fieldName?cap_first }Tree();" readonly="readonly" >
					               <#-- update--end--author:Yandong date:20180320 for:TASK #2574 【代码生成器】代码生成效果有问题 1. 树控件样式 2. 有附件的，应该弹窗宽一些 -->
